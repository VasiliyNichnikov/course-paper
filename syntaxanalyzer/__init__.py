...
# Если текущий токен равен while, то перехолим в condition_cycle (условный цикл)
...
# Повтаряем предыдущий шаг, перед циклом
...
# Запускаем цикл, пока в лексеме встречаются "*", "/", "&&"
# Повяторяем предыдущий шаг, перед циклом
